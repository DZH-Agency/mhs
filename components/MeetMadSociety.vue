<template>
  <div class="society-wrapper">
    <div class="container">
      <div class="society">
        <h2 class="society-content__heading mobile-only">
          Meet the <br> <span class="text-purple-gradient">Mad Hare Society.</span>
        </h2>
        <div class="society-cards">
          <img src="/MeetMadSociety/cards.png" alt="cards" class="society-cards__img">
        </div>
        <div class="society-content">
          <h2 class="society-content__heading desktop-only">
            Meet the <br> <span class="text-purple-gradient">Mad Hare Society.</span>
          </h2>
...
@import "~@/assets/scss/components/MeetMadSociety.scss";
</style>
